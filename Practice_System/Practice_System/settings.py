"""
Django settings for Practice_System project.
...
SECRET_KEY = 'o3b@+ssp0hu_#9_hd3!8ywuve0v$&w)nxn3#l6woe$@n8-oa4x'
...
WSGI_APPLICATION = 'Practice_System.wsgi.application'
